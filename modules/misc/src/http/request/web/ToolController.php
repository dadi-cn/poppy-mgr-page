...
class ToolController extends WebController
{
    ...
    {
        return view('misc::web.tool.index');
    }
    ...
    public function format($type = 'xml')
    {
        ...
        return view('misc::web.tool.format', [
            'type' => $type,
        ]);
    }
    ...
    public function mdExtend()
    {
        ...
        return view('misc::web.tool.md_extend');
    }
    ...
    public function htmlEntity()
    {
        ...
        return view('misc::web.tool.html_entity');
    }
    ...
    public function sslKey()
    {
        ...
        return view('misc::web.tool.ssl_key');
    }
    ...
    public function manToMd()
    {
        ...
        return view('misc::web.tool.man_to_md');
    }
