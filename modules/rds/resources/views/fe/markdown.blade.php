@extends('slt::fe.template.bt3-doc')
@section('bt3-doc-main')
    <div class="container">
        @include('slt::fe.header_markdown')
    </div>
            ...
            <ul class="nav navbar-nav">
                @foreach($dirs as $dir)
                    <li @if ($dir == $current_dir)  class="active" @endif>
                        <a href="{!! route_url('slt:fe.md', ['dir'=> $dir]) !!}" title="{!! $dir !!}">{!! $dir !!}</a>
                    </li>
                @endforeach
            </ul>
        </div>
                                        ...
                                        <ul class="nav">
                                            @foreach($file_sub['files'] as $f)
                                                <li class="@if ( $detail['fb'] == $f)active @endif" data-title="{!!  $f !!}">
                                                    <a href="{!! route_url('slt:fe.md', ['dir'=> $current_dir,'file'=> $f]) !!}"
