...
use Poppy\MgrPage\Classes\Form\NestedForm;
use function old;
...
class HasMany extends Field
{
     ...
     */
    protected $views = [
        'default' => 'py-mgr-page::tpl.form.hasmany',
        'tab'     => 'py-mgr-page::tpl.form.hasmanytab',
        'table'   => 'py-mgr-page::tpl.form.hasmanytable',
    ];
    ...
    {
        $form = new \Poppy\MgrPage\Classes\Form\NestedForm($column, $model);
